...
package body Carthage.Planets.Surfaces is
   ...
   begin
      ...
      declare
         ...
         Terrain_Table : array (Height_Range) of Carthage.Terrain.Terrain_Type;
         ...
         for Y in Tiles'Range (2) loop
            for X in Tiles'Range (1) loop
               declare
                  ...
                  Feature : constant Terrain_Type :=
                              Terrain_Table (Heights (X, Y));
                  Base    : constant Terrain_Type :=
                              (if Feature.Water
                               then Feature
               ...
               begin
                  ...
                  Tiles (X, Y) :=
                    Carthage.Tiles.Configure.Create_Tile
